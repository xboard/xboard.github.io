...
In a quasi experiment your treatment and control group are not divided by a completely random process but by a natural process (i.e time, location, etc) but are considered close enough to compute estimates.
